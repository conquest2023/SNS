...
import com.snsService.sns.repository.AlarmEntityRepository;
import com.snsService.sns.repository.UserEntityRepository;
import com.snsService.sns.util.JwtTokenUtils;
...
public class UserService {
   ...
   private  final BCryptPasswordEncoder encoder;
    ...
    public String  login(String userName,String  password){
        //회원가입 여부 체크
      UserEntity user=   userEntityRepository.findByUserName(userName).orElseThrow(()->new SnsApplicationException(ErrorCode.USER_NOT_FOUND,String.format("%s not Found",userName)));
